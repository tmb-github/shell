/**
* appendToCssClosure.mjs - v2.2.0
* Copyright (c) 2018-2023 Thomas M. Brodhead <https://bmt-systems.com>
* Released under the MIT license
* Date: 2023-11-01
* NB: Use https://javascript-minifier.com/ to minify, not closure compiler
*/
...
main = function () {
	...
	var returnAppendToCSSClosure;

	returnAppendToCSSClosure = function (nonce) {

		var appendToCSSClosure;

		appendToCSSClosure = function (selector, declarations, sheetIdName = 'dynamic-style-element') {
...
// sheet:
		...
		return appendToCSSClosure;

	};

	return returnAppendToCSSClosure;
