...
$site_wide_edits_template_js = $absolute_root . $assets_folder . 'javascript/siteWideEdits.TEMPLATE.js';
...
// E.g., enqueue({src: 'javascript/jQuery-3.4.1.min.js'});
	$matches = '';
...
// E.g., loadLocalResource.js('javascript/pureJsCarousel.min.js')
	$matches = '';
...
// Auto-version the service worker:
	...
	file_put_contents($absolute_root . $assets_folder . 'javascript/siteWideEdits.js', $sitewide_template);
