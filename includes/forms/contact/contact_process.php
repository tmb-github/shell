...
// This is referencing the 'includes' folder in the local directory:
...
// As of Nov 2022, inmotionhosting no longer allows emails
// to be sent using the sender's address on a contact form
// UNLESS it's listed as an addres on the account.
// Solution: use your own SMTP address, or create visitor@[DomainName] on cPanel and use that.
// OLD: $mail->setFrom($sender_email, $sender_name);
$mail->setFrom($smtp_visitor, $sender_name);
...
//$mail->addAttachment('images/phpmailer_mini.png'); // Attach an image file if desired
