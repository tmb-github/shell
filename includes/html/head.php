...
// 2023-10-31
// qwer:htaccess
if (file_exists($absolute_root . 'pages/' . $page . '/meta-schema-overrides.inc.php')) {
	include $absolute_root . 'pages/' . $page . '/meta-schema-overrides.inc.php';
};
...
<?php /* DO NOT PUT target=_blank ON BASE */ ?>
