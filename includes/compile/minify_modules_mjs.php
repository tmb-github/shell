...
echo 'Minifying assets/javascript/modules/*.mjs . . .' . PHP_EOL;
...
// Is there really a case where assets/javascript/scripts should not become assets/javascript/minified-scripts?
