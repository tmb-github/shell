...
echo 'Minifying assets/javascript/scripts/*.js . . .' . PHP_EOL;
...
//foreach (glob($absolute_root . 'assets/javascript/scripts/polyfill-css-var.js') as $filename) {
//foreach (glob($absolute_root . 'assets/javascript/scripts/passiveSupport.js') as $filename) {
...
// C:/xampp/htdocs/qa/assets/javascript/scripts/./loader.js
// 2023-11-01:
// qwer.htaccess
// IMPORTANT: Note dot! /./
