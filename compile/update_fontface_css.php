...
//$loader_template = file_get_contents($absolute_root . 'javascript/loader-template.js');
$font_face_template_css = $absolute_root . 'css/font-face.TEMPLATE.css';

if (file_exists($font_face_template_css)) {
	$fontface_css_content = file_get_contents($font_face_template_css);

//$fontface_css_content = file_get_contents($absolute_root . 'css/font-face.TEMPLATE.css');

	$fontface_css_content = str_replace('/###ROOT-FOLDER###/', $root_folder, $fontface_css_content);
	file_put_contents($absolute_root . 'css/font-face.css', $fontface_css_content);
} else {
