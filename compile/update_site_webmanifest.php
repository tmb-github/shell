...
$site_webmanifest .= '      "src": "' . substr($favicon_ico, 9) . '",' . PHP_EOL; 
$site_webmanifest .= '      "type": "image/x-icon",' . PHP_EOL; 
$site_webmanifest .= '      "sizes": "48x48"' . PHP_EOL; 
$site_webmanifest .= '    }, {' . PHP_EOL; 
/*
// remove initial 'favicons/':
$site_webmanifest .= '      "src": "' . substr($maskable_icon_64x64_png, 9) . '",' . PHP_EOL; 
...
*/
// remove initial 'favicons/':
$site_webmanifest .= '      "src": "' . substr($maskable_icon_192x192_png, 9) . '",' . PHP_EOL; 
$site_webmanifest .= '      "sizes": "192x192",' . PHP_EOL; 
$site_webmanifest .= '      "type": "image/png",' . PHP_EOL; 
$site_webmanifest .= '      "purpose": "maskable"' . PHP_EOL;
$site_webmanifest .= '    }, {' . PHP_EOL; 
// remove initial 'favicons/':
$site_webmanifest .= '      "src": "' . substr($maskable_icon_512x512_png, 9) . '",' . PHP_EOL; 
...
// remove initial 'favicons/':
$site_webmanifest .= '      "src": "' . substr($android_chrome_192x192_png, 9) . '",' . PHP_EOL; 
$site_webmanifest .= '      "sizes": "192x192",' . PHP_EOL; 
$site_webmanifest .= '      "type": "image/png"' . PHP_EOL; 
$site_webmanifest .= '    }, {' . PHP_EOL; 
// remove initial 'favicons/':
/*
$site_webmanifest .= '      "src": "' . substr($android_chrome_256x256_png, 9) . '",' . PHP_EOL; 
$site_webmanifest .= '      "sizes": "256x256",' . PHP_EOL; 
$site_webmanifest .= '      "type": "image/png"' . PHP_EOL; 
$site_webmanifest .= '    }, {' . PHP_EOL; 
*/
// remove initial 'favicons/':
$site_webmanifest .= '      "src": "' . substr($android_chrome_512x512_png, 9) . '",' . PHP_EOL; 
$site_webmanifest .= '      "sizes": "512x512",' . PHP_EOL; 
$site_webmanifest .= '      "type": "image/png"' . PHP_EOL; 
$site_webmanifest .= '    }],' . PHP_EOL; 
...
file_put_contents($absolute_root . 'favicons/site.webmanifest', $site_webmanifest);