...
<head prefix="og: http://ogp.me/ns# article: http://ogp.me/ns/article#" typeof="http://ogp.me/ns#">
	...
	<meta name="msapplication-config" content="<?php echo $base_href; ?>assets/favicons/browserconfig.xml">
	...
	<meta property="og:image" content="<?php echo $base_href; ?>assets/images/head/<?php echo $site_title_short_form_lc; ?>-1200x630.jpg">
	<meta property="og:image:alt" content="<?php echo $site_title; ?>">
	<meta property="og:image:height" content="630">
	<meta property="og:image:width" content="1200">
	<meta property="og:image:secure_url" content="<?php echo $base_href; ?>assets/images/head/<?php echo $site_title_short_form_lc; ?>-1200x630.jpg">
	...
	<meta name="twitter:image" content="<?php echo $base_href; ?>assets/images/head/<?php echo $site_title_short_form_lc; ?>-1200x630.jpg">
